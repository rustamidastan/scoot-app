<template>
  <div class="about">
    ...
    <Aims :aims="aims" />
    <Features :features="features" :title="featureTitle" />
    <FAQs :faqs="faqs" />
    <Footer />
  </div>
</template>
      ...
      aims: [
        {
          ...
          link: false,
          img: require("../assets/about-mobility.png"),
        },
        {
          ...
          link: false,
          img: require("../assets/about-better.png"),
        },
      ],

      featureTitle: "Our values",

      features: [
        {
          title: "Our tech",
          img: require("../assets/about-values-1.png"),
